const siteMetadata = {
    ...
    description: `Mojok adalah media online santai yang berisi konten seputar isu-isu sosial, politik, agama, dan budaya pop. Media opini nomor satu di Indonesia..`,
    about:
